...
object AlloyanceItems {
    ...
    val END_MEUTOITE_ORE = block(AlloyanceBlocks.END_MEUTOITE_ORE)
    val MEUTOITE_BLOCK = block(AlloyanceBlocks.MEUTOITE_BLOCK)
    ...
    val NETHER_SANGUINITE_ORE = block(AlloyanceBlocks.NETHER_SANGUINITE_ORE)
    val SANGUINITE_BLOCK = block(AlloyanceBlocks.SANGUINITE_BLOCK)
    ...
    val NETHER_LUTETIUM_ORE = block(AlloyanceBlocks.NETHER_LUTETIUM_ORE)
    val LUTETIUM_BLOCK = block(AlloyanceBlocks.LUTETIUM_BLOCK)
    ...
    val KRIK_BLOCK = block(AlloyanceBlocks.KRIK_BLOCK)
