...
object AlloyanceItemTags {
    ...
    val RAW_MATERIALS_ATLARUS: TagKey<Item> = rawMaterials(ATLARUS)
    val INGOTS_ATLARUS: TagKey<Item> = ingots(ATLARUS)
    val NUGGETS_ATLARUS: TagKey<Item> = nuggets(ATLARUS)
    val DUSTS_ATLARUS: TagKey<Item> = dusts(ATLARUS)
    val STORAGE_BLOCKS_ATLARUS: TagKey<Item> = storageBlocks(ATLARUS)
    val ORES_ATLARUS: TagKey<Item> = ores(ATLARUS)
    val ALLOYABLES_ATLARUS: TagKey<Item> = alloyables(ATLARUS)

    val RAW_MATERIALS_ADAMANTINE: TagKey<Item> = rawMaterials(ADAMANTINE)
    val INGOTS_ADAMANTINE: TagKey<Item> = ingots(ADAMANTINE)
    val NUGGETS_ADAMANTINE: TagKey<Item> = nuggets(ADAMANTINE)
    val DUSTS_ADAMANTINE: TagKey<Item> = dusts(ADAMANTINE)
    val STORAGE_BLOCKS_ADAMANTINE: TagKey<Item> = storageBlocks(ADAMANTINE)
    val ORES_ADAMANTINE: TagKey<Item> = ores(ADAMANTINE)
    val ALLOYABLES_ADAMANTINE: TagKey<Item> = alloyables(ADAMANTINE)

    val RAW_MATERIALS_ALDUORITE: TagKey<Item> = rawMaterials(ALDUORITE)
    val INGOTS_ALDUORITE: TagKey<Item> = ingots(ALDUORITE)
    val NUGGETS_ALDUORITE: TagKey<Item> = nuggets(ALDUORITE)
    val DUSTS_ALDUORITE: TagKey<Item> = dusts(ALDUORITE)
    val STORAGE_BLOCKS_ALDUORITE: TagKey<Item> = storageBlocks(ALDUORITE)
    val ORES_ALDUORITE: TagKey<Item> = ores(ALDUORITE)
    val ALLOYABLES_ALDUORITE: TagKey<Item> = alloyables(ALDUORITE)

    val RAW_MATERIALS_LUTETIUM: TagKey<Item> = rawMaterials(LUTETIUM)
    val INGOTS_LUTETIUM: TagKey<Item> = ingots(LUTETIUM)
    val NUGGETS_LUTETIUM: TagKey<Item> = nuggets(LUTETIUM)
    val DUSTS_LUTETIUM: TagKey<Item> = dusts(LUTETIUM)
    val STORAGE_BLOCKS_LUTETIUM: TagKey<Item> = storageBlocks(LUTETIUM)
    val ORES_LUTETIUM: TagKey<Item> = ores(LUTETIUM)
    val ALLOYABLES_LUTETIUM: TagKey<Item> = alloyables(LUTETIUM)

    val INGOTS_INOLASHITE: TagKey<Item> = ingots(INOLASHITE)
    val NUGGETS_INOLASHITE: TagKey<Item> = nuggets(INOLASHITE)
    val DUSTS_INOLASHITE: TagKey<Item> = dusts(INOLASHITE)
    val STORAGE_BLOCKS_INOLASHITE: TagKey<Item> = storageBlocks(INOLASHITE)
    val ALLOYABLES_INOLASHITE: TagKey<Item> = alloyables(INOLASHITE)

    val INGOTS_KRIK: TagKey<Item> = ingots(KRIK)
    val NUGGETS_KRIK: TagKey<Item> = nuggets(KRIK)
    val DUSTS_KRIK: TagKey<Item> = dusts(KRIK)
    val STORAGE_BLOCKS_KRIK: TagKey<Item> = storageBlocks(KRIK)
    val ALLOYABLES_KRIK: TagKey<Item> = alloyables(KRIK)

    val INGOTS_TARTARITE: TagKey<Item> = ingots(TARTARITE)
    val NUGGETS_TARTARITE: TagKey<Item> = nuggets(TARTARITE)
    val DUSTS_TARTARITE: TagKey<Item> = dusts(TARTARITE)
    val STORAGE_BLOCKS_TARTARITE: TagKey<Item> = storageBlocks(TARTARITE)
    val ALLOYABLES_TARTARITE: TagKey<Item> = alloyables(TARTARITE)

    val INGOTS_ETHERIUM: TagKey<Item> = ingots(ETHERIUM)
    val NUGGETS_ETHERIUM: TagKey<Item> = nuggets(ETHERIUM)
    val DUSTS_ETHERIUM: TagKey<Item> = dusts(ETHERIUM)
    val STORAGE_BLOCKS_ETHERIUM: TagKey<Item> = storageBlocks(ETHERIUM)
    val ALLOYABLES_ETHERIUM: TagKey<Item> = alloyables(ETHERIUM)
