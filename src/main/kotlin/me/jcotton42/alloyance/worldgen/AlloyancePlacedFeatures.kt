...
object AlloyancePlacedFeatures {
    ...
    val PHOSPHORITE_ORE = registerKey("phosphorite_ore")
    ...
    fun bootstrap(context: BootstrapContext<PlacedFeature>) {
        ...
        register(
            context,
            ALDUORITE_ORE,
            configuredFeatures.getOrThrow(AlloyanceConfiguredFeatures.ALDUORITE_ORE),
            countOrePlacement(
                UNCOMMON,
                HeightRangePlacement.uniform(VerticalAnchor.absolute(70), VerticalAnchor.TOP)
            )
        )
        register(
            context,
            LUTETIUM_ORE,
            configuredFeatures.getOrThrow(AlloyanceConfiguredFeatures.LUTETIUM_ORE),
            countOrePlacement(
                VERY_RARE,
        ...
        register(
            context,
            PHOSPHORITE_ORE,
            configuredFeatures.getOrThrow(AlloyanceConfiguredFeatures.PHOSPHORITE_ORE),
            countOrePlacement(
                UNCOMMON,
                HeightRangePlacement.uniform(VerticalAnchor.BOTTOM, VerticalAnchor.absolute(80))
            )
        ...
        register(
            context,
            SULFUR_ORE,
            configuredFeatures.getOrThrow(AlloyanceConfiguredFeatures.SULFUR_ORE),
            countOrePlacement(
                UNCOMMON,
                HeightRangePlacement.triangle(VerticalAnchor.absolute(-56), VerticalAnchor.absolute(-22))
            )
        )
    }
